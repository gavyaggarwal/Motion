...
{
    //UIColor *background = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.1];
    //return background.CGColor;
	static CGColorRef c = NULL;
	if (c == NULL)
	{
		//c = CreateDeviceGrayColor(0.6, 1.0);
        c = [UIColor clearColor].CGColor;
	}
	return c;
}
...
CGColorRef graphLineColor()
{
	...
	if (c == NULL)
	{
        c = [[UIColor whiteColor] colorWithAlphaComponent:0.7].CGColor;
